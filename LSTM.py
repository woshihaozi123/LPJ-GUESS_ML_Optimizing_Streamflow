...
if __name__ == '__main__':
    ...
    train_data_ratio = 0.6667  # Choose 80% of the data for testing
    ...
    plt.plot(t_for_training, predictive_y_for_training, 'y--', label='pre_GRDC_trn',linewidth=1.5)

    plt.plot(t_for_testing, test_x, 'c', label='LPJGUESS_tst',linewidth=1.5)
    plt.plot(t_for_testing, test_y, 'k', label='ref_GRDC_tst',linewidth=1.5)
    plt.plot(t_for_testing, predictive_y_for_testing, 'm--', label='pre_GRDC_tst',linewidth=1.5)

    plt.plot([t[train_data_len], t[train_data_len]], [0, 6], 'r--', label='separation line',linewidth=1.5)  # separation line
